...
public:
    ...
    virtual void HdlKeyUp() override { } // Optional, depending on needs
    virtual void HdlKeyDown() override { } // Optional, depending on needs
...
private:
    ...
    std::string textContent;    // Current text content of the field
